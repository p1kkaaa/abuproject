...
import hist from './../../img/photo/history.jpg';
import arch from './../../img/photo/archeology.jpg';
import pale from './../../img/photo/paleography.jpg';
import arrowimg from './../../img/obj/arrow.svg';
import styles from './Itemcard.module.css'; // ✅ Подключение CSS-модуля


const images = [hist, arch, pale];
    ...
    <div className={styles.math}>
      <div className={styles.math__imageWrapper}>
        ...
        <div className={styles.math__overlay}>
          <p className={styles.math__overlayText}>История, Археология, Палеография</p>
      ...
      <div className={styles.math__body}>
        <div className={styles.math__text}>
          <div className={styles.math__title}>Гуманитарная Наука</div>
        </div>
